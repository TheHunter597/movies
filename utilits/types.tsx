...
export interface state {
    ...
    chosenMovie:{
        id:string,
        streamingServices:{disney?:{us:{link:string}},netflix?:{us:{link:string}},hbo?:{us:{link:string}}},
        data:{Title:string,Poster:string,Year:string,Genre:string,Director:string,Type:string,imdbID:string,BoxOffice:string,Actors:string,Awards:string,Plot:string,Writer:string,Ratings:{Source:string,Value:string}[],Metascore:string,imdbRating:string},
        youtubeVideos:[],
        actors:{
            actorsInfo:{id:string,name:string}[],
            actorsData:{results:{birthYear:number,
    ...
    favsMovies:{id:string,data:{Title:string,imdbID:string,Poster:string,Year:number}}[],
